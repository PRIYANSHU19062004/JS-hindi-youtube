...
let userBooks=books.filter((bk)=>bk.genre==='History') //Userbooks contains those objects which contain 'History' as genre.As no curly brackets so we can't return anything.
