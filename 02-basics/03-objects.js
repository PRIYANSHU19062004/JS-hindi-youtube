//Objects can be declared in two ways -like a literal and like a constructor
...
/////////////////++++++++++/////////////
//Object literals
const mySym=Symbol("key1") //Declaring a symbol.'mySym' is the name of the symbol.Inside the bracket "key1" and "key2" are just descriptions for the easy debugging and readability.No difference if not written.
...
console.log(JsUser["email"])//more better way to access an object especially when keys have spaces in between.
...
console.log(JsUser[mySym1])//wll give output mykey2 and the only way to access the symbol.
